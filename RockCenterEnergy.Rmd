...
A look at three years of electric and steam consumption at Rockefeller Center using annual costs and consumptions. Intresting to note the reudcitons from 2019 a pre-Covid year to both years 2020 and 2021 to see a relitatively consistant differences of  `r CampusDelta[2,4]` and 
...
group_by(Property, "Year" = year(Date), "Month" = month(Date)) %>% 
  summarise(Population = sum(Total.Entrants)) %>% 
  ggplot(aes(x = Property, y = Population, fill = Year, group = Year)) +
