...
UtilityData1 %>% 
  ...
  UtilityData1 %>% 
    mutate("24Carbon/SF" = ifelse(Unit == "kwh", Value * ElecCF24, Value * SteamCF24)) %>% 
    select(Building, Year, Unit, `24Carbon/SF`) %>% 
...
kable( format = "html", col.names = c("Building", "Carbon/GSF", "Total Carbon", "2024 Penanity"), align = "lllc", caption = "<center><strong><strong>Penality Tabulation</strong></strong></center>", digits = getOption("digits"), booktabs = T ) %>% 
