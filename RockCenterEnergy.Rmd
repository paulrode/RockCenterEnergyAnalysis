...
'GridFactor2030' <- 0.5
'GridFactor2050' <- 0.1 
'ElecCF24' <- 0.000288962  #2024 Carbon Value
'SteamCF24' <- 0.00004493 #2024 Carbon Value
'ElecCF30' <- 0.000288962 * `GridFactor2030`#2030 Carbon Value
'SteamCF30' <- 0.00004493 * `GridFactor2030` #2024 Carbon Value
...
UtilityData1 %>% 
  ...
  UtilityData1 %>% 
    mutate("Carbon/SF" = ifelse(Unit == "kwh", Value * ElecCF24, Value * SteamCF24)) %>% 
...
kable( format = "html", col.names = c("Building", "Carbon/GSF", "Total Carbon", "Net Penanity"), align = "lllc", caption = "<center><strong><strong>Penality Tabulation</strong></strong></center>", digits = getOption("digits"), booktabs = T ) %>% 
