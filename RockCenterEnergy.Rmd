...
```{r Data Setup, echo=FALSE, message=FALSE, warning=FALSE, error=FALSE}
EPA_All_Data <- read_excel("data/EPA_Annual_Energy_Use_By_MeterAllBuld.xlsx", sheet = "Annual Usage", range = "A6:BB158" , col_names = TRUE, na = "Not Available", col_types = NULL ) 
