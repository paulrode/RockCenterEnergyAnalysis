...
ElectricData2 <- read_excel("data/LL97 Fines Rock Center - new rules.xlsx", sheet = "LL97 Fines", range = "A3:J14", col_names = TRUE, na = "NA", col_types = NULL)
...
kable(UtilityDataT2, format = "html", col.names = c("Building", "Carbon/GSF", "Total Carbon", "Net Penanity"), align = "lllc", caption = "<center><strong><strong>Penality Tabulation</strong></strong></center>", digits = getOption("digits"), booktabs = T ) %>% 
